...
class GistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post gists_url, params: { gist: { body: @gist.body, secret: @gist.secret, title: @gist.title, user_id: @gist.user_id } }
    end
  ...
  test "should update gist" do
    patch gist_url(@gist), params: { gist: { body: @gist.body, secret: @gist.secret, title: @gist.title, user_id: @gist.user_id } }
